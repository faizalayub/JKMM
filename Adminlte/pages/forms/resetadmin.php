<?php
  ...
  $admin_id = $_GET['resetadmin'];
  $recordss = mysqli_query($connection, "SELECT * FROM admin WHERE Admin_ID='$admin_id'");

  if (mysqli_num_rows($recordss) > 0) {
    $admin = mysqli_fetch_array($recordss);
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tetapkan semula Kata Laluan Admin</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary" >
              <div class="card-header">
                <h3 class="card-title">Sila Kemaskini Kata Laluan Admin</small></h3>
              </div>
              <!-- /.card-header -->

              <!-- form start -->
              <form role="form" id="view admin" method="post" action="adminfunction.php">
                <div class="card-body">
                  ...
                  <button type="submit" class="btn btn-primary" name="resetadmin">Sahkan Kata Laluan</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
