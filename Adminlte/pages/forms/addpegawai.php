        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../forms/addpegawai.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Daftar Pegawai</p>
                </a>
              </li>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form role="form" id="quickForm" method="post" action="pegawaifunction.php">
                <div class="card-body">
                  <div class="form-group">
                    <label>Nama Penuh</label>
                    <input type="text" class="form-control" id="namapenuh" name="chief_name" placeholder="" style="text-transform:uppercase" required>
                  </div>
                  <div class="form-group">
                    <label >No Kad Pengenalan</label>
                    <input type="text" class="form-control" id="ic" name="chief_ic" placeholder="Contoh: 930101046140" required>
                  </div>
                  <div class="form-group">
                    <label>Jabatan</label>
                  ...
                  <div class="form-group">
                    <label>Jawatan</label>
                    <input type="text" class="form-control" id="jawatan" name="chief_position" placeholder="" style="text-transform:uppercase" required>
                  </div>
                  <div class="form-group">
                    <label>Gred</label>
                    <input type="text" class="form-control" id="gred" name="chief_grade" placeholder="" style="text-transform:uppercase" required>
                  </div>
                  <div class="form-group">
                    <label>No. Tel HP</label>
                    <input type="text" class="form-control" id="phone" name="chief_contactno" placeholder="Contoh: 0171234567" required>
                  </div>
                  <div class="form-group">
                    <label>Email</label>
                    <input type="text" class="form-control" id="email"  name="chief_email" placeholder="" required>
