<?php
  ...
  if(isset($_GET['resetpegawai'])) {
  $chief_id = $_GET['resetpegawai'];
  $records = mysqli_query($connection, "SELECT * FROM chief WHERE Chief_ID='$chief_id'");

  if (mysqli_num_rows($records) > 0) {
    $chief = mysqli_fetch_array($records);
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tetapkan semula Kata Laluan Pegawai</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary" >
              <div class="card-header">
                <h3 class="card-title">Sila Kemaskini Kata Laluan Pegawai</small></h3>
              </div>
              <!-- /.card-header -->
              ...
              <form role="form" id="view pegawai" method="post" action="pegawaifunction.php">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="password" name="chief_password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,20}" title="Password must contain at least 1 number, 1 uppercase and 1 lowercase letter. 
                    The password length should be at least 8 or more characters, may contains symbols" value="<?php echo $chief_password; ?>" required>
                  </div>
                  <!-- post hidden input chief_id -->
                  <input type="hidden" name="chief_id" value="<?php echo $chief_id; ?>">
                  <button type="submit" class="btn btn-primary" name="resetpegawai">Update Pegawai</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
