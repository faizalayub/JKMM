        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Data Penuh Pegawai</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
            <div class="ex1">
              <?php          
              $results = mysqli_query($connection, "SELECT * FROM chief left join department on chief.Department_ID = department.Department_ID"); 
              $counter = 1;
              ?>
            <table id="example1" class="table table-bordered" style="text-transform:uppercase" style="font-size:14px !important">
              ...
              <?php while ($row = mysqli_fetch_array($results)) { ?>
                ...
                <td style="text-align:center"><?php echo $counter; ?></td> 
				        <td><?php echo $row['Chief_Name']; ?></td>
				        <td><?php echo $row['Chief_IC']; ?></td>          
				        <td><?php echo $row['Department_Name']; ?></td>
                <td><?php echo $row['Chief_Position']; ?></td>
                <td style="text-align:center"><?php echo $row['Chief_Grade']; ?></td>
                <td style="text-align:center">
				      	<a href="../forms/editpegawai.php?editpegawai=<?php echo $row['Chief_ID'];?>" class="edit_btn btn"><i class="fa fa-pencil-square-o"></i></a>
                <a href="../forms/resetpegawai.php?resetpegawai=<?php echo $row['Chief_ID'];?>" class="reset_btn btn"><i class="fa fa-key"></i></a>
					      <a href="data.php?delpegawai=<?php echo $row['Chief_ID'];?>" onClick="return confirm('Adakah anda pasti untuk hapuskan data ini?');" class="del_btn btn"><i class="fa fa-trash-o"></i></a>
				        </td>
                </tr>              
              <?php $counter++; } ?>
