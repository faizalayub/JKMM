<?php
  ...
  // DELETE CHIEF
	if (isset($_GET['delcourse'])) {
		$course_id = $_GET['delcourse'];
		mysqli_query($connection, "DELETE course from course left join staff on course.Staff_ID = staff.Staff_ID WHERE Course_ID = $course_id");
		
		echo"<script>window.alert('Data Kursus telah dihapuskan')</script>";
        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="ex1">
              ...
              <?php 
              $results = mysqli_query($connection, "SELECT * from course left join staff on course.Staff_ID = staff.Staff_ID  WHERE Chief_ID='".$chief_id2."'"); 
              $counter = 1;
              ?>
              ...
              <table id="example1" class="table table-bordered" style="text-transform:uppercase" style="font-size:14px !important">
                ...
                <?php while ($row = mysqli_fetch_array($results)) { ?>
                  ...
                  <a href="../forms/kursusupdate.php?editcourse=<?php echo $row['Course_ID'];?>" class="edit_btn btn"><i class="fa fa-pencil-square-o"></i></a>
              
                  <a href="data.php?delcourse=<?php echo $row['Course_ID'];?>" onClick="return confirm('Adakah anda pasti untuk hapuskan data ini?');" class="del_btn btn"><i class="fa fa-trash-o"></i></a>
                  </td> 
                </tr>
                <?php $counter++; } ?>
