      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../forms/staffadd.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Daftar Staff</p>
                </a>
              </li>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form role="form" id="quickForm" method="post" action="stafffunction.php">
                <div class="card-body">
                  <div class="form-group">
                    <label>Nama Penuh</label>
                    <input type="text" class="form-control" id="namapenuh" name="staff_name" placeholder="" style="text-transform:uppercase" required>
                  </div>
                  <!--<div class="form-group">
                    <label>Jabatan</label>
                    <select class="form-control" name="staff_dept" style="text-transform:uppercase" required>
                  ...
                  <div class="form-group">
                    <label>Jawatan</label>
                    <input type="text" class="form-control" id="jawatan" name="staff_position" placeholder="" style="text-transform:uppercase" required>
                  </div>
                  <div class="form-group">
                    <label>Gred</label>
                    <input type="text" class="form-control" id="gred" name="staff_grade" placeholder="" style="text-transform:uppercase" required>
                  </div>
                  <div class="form-group">
                    <label>Kumpulan Perkhidmatan</label>
                    <input type="text" class="form-control" id="group" name="staff_group" placeholder="" style="text-transform:uppercase" required>
                  </div>
                </div>
                <!-- /.card-body -->
